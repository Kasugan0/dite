...
from .pdf.vlm import VLMSamplingResult, extract_pdf_with_vlm_sampling
from .resolve import resolve_document_extraction as _resolve_document_extraction
...
def resolve_document_extraction(
    ...
    *,
    ...
    return _resolve_document_extraction(
        file_path,
        client,
        config=config,
